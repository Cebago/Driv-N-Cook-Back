    ...
    <form method="POST" action="./functions/sendEmail.php">
        <div>
            <div class="custom-control custom-radio custom-control-inline"
                 onchange="sendToMe('<?php echo $_SESSION['email'] ?>')">
        ...
        <div class="input-group mb-3 mt-3">
            ...
            <input type="text" class="form-control" name="subject" placeholder="Objet du mail"
                   aria-label="Objet du mail" aria-describedby="basic-addon1" required>
        </div>
