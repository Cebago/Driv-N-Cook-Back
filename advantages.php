...
<body>
        ...
        <table class="table table-striped">
            ...
            foreach ($advantages as $advantage) { ?>
                <tr>
                    ...
                    <td><a href="./functions/deleteAdvantage.php?id=<?php echo $advantage["idAdvantage"] ?>" class="btn btn-warning" >Supprimer cet avantage</a></td>
                </tr>
            <?php
            }
            ?>
    ...
    <div class="modal fade" id="advantageModal" tabindex="-1" role="dialog" aria-labelledby="advantageModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Nom de l'avantage" name="advantageName" aria-label="advantagePoints" aria-describedby="advantageName" required>
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="advantagePoints">Nombre de points</span>
                            </div>
                            <input type="number" min="0" class="form-control" placeholder="Nombre de points" name="advantagePoints" aria-label="advantagePoints" aria-describedby="advantagePoints" required>
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
