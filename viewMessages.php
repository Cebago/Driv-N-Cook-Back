...
<div class="row justify-content-center" style="margin-top: 20px;">
    <div class="col-md-10">
        <table class="table table-striped table-bordered table-hover table-hover-cursor" style="table-layout: fixed"
               id="tblData">
            ...
            foreach ($messages as $message) {
                ...
                <tr <?php echo $message["isRead"] ? '' : 'style="font-weight: bold"' ?> class="d-flex">
                    <td class="text-truncate col-2">v</
                    </td>
                    ...
                    <td class="col-1">
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                                data-target="#modal<?php echo $message["idContact"] ?>"><i class="fab fa-readme"></i>
                        </button>
                    </td>
                </tr>
...
<?php foreach ($messages as $message) { ?>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modal<?php echo $message["idContact"] ?>" data-backdrop="static" data-keyboard="false"
         tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"
                        id="staticBackdropLabel"><?php echo $message["firstname"] . ' ' . $message["lastname"] ?></h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"
                            onclick="location.href='mailto:<?php echo $message["emailAddress"] ?>' ">Répondre
                    </button>
                </div>
            </div>
        </div>
