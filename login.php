                    ...
                    <form method="POST" action="login.php">
                        <div class="form-group">
                            <div class="form-label-group">
                                ...
                                <input type="email" id="inputEmail" class="form-control focus" placeholder="Adresse mail" required="required" autofocus="autofocus" name="inputEmail" value="<?php echo (isset($_POST['inputEmail']))?$_POST['inputEmail']:'' ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-label-group">
                                ...
                                <input type="password" id="inputPassword" class="form-control focus" placeholder="Mot de passe" required="required" name="inputPassword">
                            </div>
                        </div>
